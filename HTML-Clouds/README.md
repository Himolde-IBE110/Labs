...
As you calready know, the Web is an information system where resources are identified by URLs and can be accessed via the HTTP protocol. It is based on 3 technologies: 
...
You can open in your browser the page you created, or alternatively you can use this one: https://himolde-ibe110.github.io/Labs/hello.html) 
